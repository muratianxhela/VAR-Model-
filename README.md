...
stargazer(pptab,type = "latex",title=" Table 1: Phillips-Perron Test Results", align=TRUE, out="table1.txt")
...
stargazer(pptab,type = "latex",title=" Phillips-Perron Test Results", align=TRUE, out="table2.txt")
...
stargazer(Lagselect$selection,type = "latex",title="A summary of the VAR-model lag selection", align=TRUE, out="table3.txt")
...
stargazer(Modeldataset1[["varresult"]],type = "latex",title="Table 4:Regression Results")
...
stargazer(stability, type = "latex", title="Table 7: Model Stability Results")
...
#stargazer(Serial1[["serial"]][["p.value"]],type = "latex",title="Portmanteau Test Result", align=TRUE)
...
stargazer(Arch1[["arch.mul"]][["p.value"]], type = "latex", title=" Multivariate ARCH-LM Test Results")
...
gctab<-round(gctab,3)
print(gctab)# JPY and USR  are indeed significant  are the variables that has an effect on Japan capital flows

stargazer(gctab, type = "latex", title="Granger Casuality TEST Results")
...
stargazer(fevdtab, type = "latex", title="Summary of the FEVD Results")
